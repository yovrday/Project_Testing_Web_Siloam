...
import com.juaracoding.ProjectSiloam.pages.LoginAdminPage;
import com.juaracoding.ProjectSiloam.step_definitions.Hooks;
...
public class TestLoginAdmin {
   ...
   public void Menampilkan_Url_yang_ingin_dikunjungi() {
	 ...
	 String expected = loginPage.getTxtLogin();
     Assert.assertEquals(loginPage.getTxtLogin(), expected);
